...
def train(n_games=200_000, n_epochs=5_000, n_eval=500, eval_vs="pubeval"):
    ...
    # Uppfæra epsilon fyrir þennan leik (ef agentinn styður það)
        if hasattr(agent, "update_epsilon_for_game"):
...
if __name__ == "__main__":
    ...
    train(n_games=30_000, n_epochs=5_000, n_eval=500, eval_vs="random")